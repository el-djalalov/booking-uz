...
export async function searchFlights(values: z.infer<typeof flightSearchSchema>) {
  ...
  const { fromAirport, toAirport, departureDate, returnDate, tripType, ...rest } = validatedFields.data;
